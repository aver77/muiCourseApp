...
export const useWithSwitchers = (handleFirstValue, handleSecondValue, firstDefaultValue, secondDefaultValue) => {
    const [firstVariable, setFirstVariable] = useState(getLocalStorageItem(firstDefaultValue) ?? false)
    const [secondVariable, setSecondVariable] = useState(getLocalStorageItem(secondDefaultValue) ?? false)
