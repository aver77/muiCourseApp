...
const WithThemeProvider = ({children}) => {
    const [currentTheme, setCurrentTheme] = useState(getLocalStorageItem(SWITCH_THEMES) ?? false);
    ...
    return (
        <ThemeProvider theme={ternaryOperation(!currentTheme, lightTheme, darkTheme)}>
            {
